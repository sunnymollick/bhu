        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="<?php echo e(route('admin.user.add')); ?>" class="btn btn-primary btn-sm float-right">
                        Create User
                    </a>
                </div>
                <div class="card-body">
                    <table class="table table-bordered" id="usersTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($u->contact_no); ?></td>
                                <td><?php echo e($u->role?->name ?? 'N/A'); ?></td>
                                <td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        <button class="btn btn-link p-0 m-0" type="button" id="actionDropdown<?php echo e($u->id); ?>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="actionDropdown<?php echo e($u->id); ?>">
                                            ...
                                            <?php endif; ?>
                                            <?php if(!$u->is_approved): ?>
                                                <a class="dropdown-item approve-user-btn" href="#" data-id="<?php echo e($u->id); ?>">
                                                    <i class="fa fa-check"></i> Approve
                                                </a>
                                            <?php endif; ?>
                                            <a class="dropdown-item toggle-active-btn" href="#" data-id="<?php echo e($u->id); ?>" data-active="<?php echo e($u->active); ?>">
...
<script>
    ...
    $(document).on('click', '.approve-user-btn', function(e) {
        ...
        var action = "<?php echo e(url('admin/user/approve')); ?>/" + userId;
    ...
    $(document).on('click', '.toggle-active-btn', function(e) {
        ...
        var action = "<?php echo e(url('admin/user/toggle-active')); ?>/" + userId;
...
<?php echo $__env->make('backend.layouts.default', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragonUpdated\www\rr-app\resources\views/backend/pages/user/all.blade.php ENDPATH**/ ?>