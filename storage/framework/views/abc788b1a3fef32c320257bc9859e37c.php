<?php $__env->startSection('title', 'Login - Bengali Hindu Unity'); ?>
...
<script>
    $(document).ready(function() {
        ...
        <?php if($errors->has('email')): ?>
            toastr.error('<?php echo e($errors->first('email')); ?>', 'Login Error');
        <?php endif; ?>

        <?php if($errors->has('password')): ?>
            toastr.error('<?php echo e($errors->first('password')); ?>', 'Validation Error');
        <?php endif; ?>
    });
</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('frontend.layouts.default', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragonUpdated\www\rr-app\resources\views/frontend/pages/auth/login.blade.php ENDPATH**/ ?>