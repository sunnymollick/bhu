        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="<?php echo e(route('admin.organization_event.create')); ?>" class="btn btn-primary btn-sm float-right">
                        Add New Event
                    </a>
                </div>
                <div class="card-body">
                            ...
                            <tr>
                                <td>
                                    <?php if($event->banner_image): ?>
                                        <img src="<?php echo e(asset('backend/uploads/organization_event/banner/' . $event->banner_image)); ?>" class="img-thumbnail" style="height: 50px; width: 80px; object-fit: cover;">
                                    <?php else: ?>
                                        <span class="badge badge-secondary">No Image</span>
                                    <?php endif; ?>
                                </td>
                                <td><?php echo e($event->event_name); ?></td>
                                <td><?php echo e($event->organization->name ?? 'N/A'); ?></td>
...
<?php echo $__env->make('backend.layouts.default', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragonUpdated\www\rr-app\resources\views/backend/pages/organization_event/all.blade.php ENDPATH**/ ?>