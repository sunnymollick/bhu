            ...
            <div class="col-lg-4 col-md-5 col-12">
                <div class="profile-hero-card">
                    ...
                    <div class="profile-avatar-wrapper">
                        <img class="profile-avatar" src="<?php echo e($user->profile_pic ? asset('backend/uploads/user/' . $user->profile_pic) : asset('frontend/assets/img/man-avatar.png')); ?>" alt="<?php echo e($user->name); ?>">
                    </div>
                    <div class="profile-info">
                        ...
                        <div class="d-flex flex-column" style="gap: 10px;">
                            <a href="<?php echo e(route('admin.user.profile.edit')); ?>" class="btn btn-edit-profile">
                                <i class="fas fa-edit mr-2"></i>Edit Profile
                            </a>
                            <?php if(!$isAdminRole): ?>
                                <button type="button" class="btn btn-student-toggle" data-toggle="modal" data-target="#studentStatusModal">
                                    <i class="fas fa-graduation-cap mr-2"></i><?php echo e($user->is_student ? 'Remove Student Status' : 'Mark as Student'); ?>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="stat-card">
                            ...
                            <div class="stat-value"><?php echo e($user->email); ?></div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="stat-card">
                            ...
                            <div class="stat-value"><?php echo e($user->contact_no ?? 'Not set'); ?></div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="stat-card">
                            ...
                            <div class="stat-value"><?php echo e($user->created_at->format('M d, Y')); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="detail-item">
                                ...
                                <div class="detail-value"><?php echo e($user->contact_no ?? 'Not provided'); ?></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="detail-item">
                                <div class="detail-label">Reference Person</div>
                                <div class="detail-value"><?php echo e($user->approver?->name ?? 'Not assigned'); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="detail-item">
                                ...
                                <div class="detail-value"><?php echo e($user->country ?? 'Not provided'); ?></div>
                            </div>
                            <div class="detail-item">
                                <div class="detail-label">Division</div>
                                <div class="detail-value"><?php echo e($user->division?->name ?? 'Not provided'); ?></div>
                            </div>
                            <div class="detail-item">
                                <div class="detail-label">District</div>
                                <div class="detail-value"><?php echo e($user->district?->name ?? 'Not provided'); ?></div>
                            </div>
                            <div class="detail-item">
                                <div class="detail-label">Upazila</div>
                                <div class="detail-value"><?php echo e($user->upazila?->name ?? 'Not provided'); ?></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="detail-item">
                                <div class="detail-label">Street Address</div>
                                <div class="detail-value"><?php echo e($user->street_address_1 ?? 'Not provided'); ?></div>
                            </div>
                            <div class="detail-item">
                                <div class="detail-label">City</div>
                                <div class="detail-value"><?php echo e($user->city ?? 'Not provided'); ?></div>
                            </div>
                            <div class="detail-item">
                                <div class="detail-label">State</div>
                                <div class="detail-value"><?php echo e($user->state ?? 'Not provided'); ?></div>
                            </div>
                            <div class="detail-item">
                                <div class="detail-label">ZIP Code</div>
                                <div class="detail-value"><?php echo e($user->zipcode ?? 'Not provided'); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-6">
                            <div class="detail-item">
                                ...
                                <div class="detail-value">
                                    <?php if($user->nid): ?>
                                        <a href="<?php echo e(asset('backend/uploads/users/documents/' . $user->nid)); ?>" target="_blank" class="text-primary">
                            ...
                            <div class="detail-item">
                                ...
                                <div class="detail-value">
                                    <?php if($user->passport): ?>
                                        <a href="<?php echo e(asset('backend/uploads/users/documents/' . $user->passport)); ?>" target="_blank" class="text-primary">
                                            <i class="fas fa-file-pdf"></i> View Document
                                        </a>
                                    <?php else: ?>
                                        <span class="text-muted">Not uploaded</span>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const isStudent = <?php echo e($user->is_student ? 'true' : 'false'); ?>;
    ...
    if (confirmBtn) {
        confirmBtn.addEventListener('click', function() {
            ...
            fetch('<?php echo e(route('admin.user.toggle.student')); ?>', {
                method: 'POST',
                headers: {
...
<?php echo $__env->make('backend.layouts.default', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragonUpdated\www\rr-app\resources\views/backend/pages/profile/profile.blade.php ENDPATH**/ ?>