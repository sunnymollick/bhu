    ...
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <div class="security-notice">
                ...
                <p>This password reset link will expire in <strong><?php echo e($expiryTime); ?> minutes</strong>.</p>
        ...
        <div class="email-footer">
            ...
            <p>
                ...
                <a href="<?php echo e(route('frontend.index')); ?>">Visit Our Website</a>
            </p>
            <p style="margin-top: 15px; font-size: 12px; color: #999;">
                © <?php echo e(date('Y')); ?> Bengali Hindu Unity. All rights reserved.
            </p>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\laragonUpdated\www\rr-app\resources\views/emails/password-reset.blade.php ENDPATH**/ ?>