<?php $__env->startSection('title', 'Contact Us - Bengali Hindu Unity'); ?>
        ...
        <div class="row">
            <div class="col-12">
                <div class="contact-wrapper">
                    <form action="<?php echo e(route('frontend.contact.submit')); ?>" method="POST" id="contactForm" novalidate>
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-lg-4">
...
<?php echo $__env->make('frontend.layouts.default', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragonUpdated\www\rr-app\resources\views/frontend/pages/contact.blade.php ENDPATH**/ ?>