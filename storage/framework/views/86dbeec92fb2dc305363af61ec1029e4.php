            ...
            <div class="col-lg-8 col-md-10 col-12">
                <div class="password-card">
                    ...
                    <div class="card-body p-4">
                        <form action="<?php echo e(route('admin.user.update.password')); ?>" method="POST" id="changePasswordForm" novalidate>
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="new_password" name="new_password" required>
...
<?php echo $__env->make('backend.layouts.default', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragonUpdated\www\rr-app\resources\views/backend/pages/profile/change_password.blade.php ENDPATH**/ ?>