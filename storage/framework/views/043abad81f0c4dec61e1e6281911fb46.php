...
<section class="content-header">
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
        <h1>Add Organization Event</h1>
        </div>
        <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="<?php echo e(route('admin.dashboard')); ?>">Home</a></li>
            <li class="breadcrumb-item"><a href="<?php echo e(route('admin.organization_event.all')); ?>">All Events</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-warning">
                    ...
                    <form method="POST" action="<?php echo e(route('admin.organization_event.store')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="organization_id" id="organization_id" class="form-control select2 <?php $__errorArgs = ['organization_id'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="card-footer">
                            ...
                            <a href="<?php echo e(route('admin.organization_event.all')); ?>" class="btn btn-default">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('backend.layouts.default', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragonUpdated\www\rr-app\resources\views/backend/pages/organization_event/create.blade.php ENDPATH**/ ?>