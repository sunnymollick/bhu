...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Dear <?php echo e($referrer->name); ?>,</p>
            ...
            <div class="info-box">
                ...
                <p><strong>Name:</strong> <?php echo e($newUser->name); ?></p>
                <p><strong>Email:</strong> <?php echo e($newUser->email); ?></p>
                <p><strong>Phone:</strong> <?php echo e($newUser->contact_no); ?></p>
                <p><strong>Registration Date:</strong> <?php echo e($newUser->created_at->format('F d, Y h:i A')); ?></p>
            </div>
            ...
            <div class="button-container">
                <a href="<?php echo e($verifyUrl); ?>" class="button button-verify">Yes, I Know This Person</a>
                <a href="<?php echo e($rejectUrl); ?>" class="button button-reject">No, I Don't Know This Person</a>
            </div>
...
<?php /**PATH C:\laragonUpdated\www\rr-app\resources\views/emails/reference-notification.blade.php ENDPATH**/ ?>