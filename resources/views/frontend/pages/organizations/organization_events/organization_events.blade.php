...
@section('title', 'Organization Events - Bengali Hindu Unity')
...
<div class="sigma_subheader">
    <div class="overlay">
        ...
        <h4 class="header-img-text">Event</h4>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="event-card">
                    <div class="event-image-wrapper">
                        <img src="{{ $event->banner_image ? asset('backend/uploads/organization_event/banner/' . $event->banner_image) : 'https://placehold.co/800x400/e76f51/ffffff?text=Event' }}" alt="{{ $event->event_name }}">
                    ...
                    <div class="event-content">
                        <h3 class="event-title">
                            <a href="{{ route('frontend.events.details', $event->id) }}">{{ $event->event_name }}</a>
                        </h3>
                        ...
                        <a href="{{ route('frontend.events.details', $event->id) }}" class="join-btn">
                            JOIN NOW
            ...
            <div class="col-lg-4">
                ...
                <div class="sidebar-widget">
                    <h5>Search</h5>
                    <form action="{{ route('frontend.organization.events') }}" method="GET" class="search-form">
                ...
                <div class="sidebar-widget">
                    ...
                    <div class="recent-event-item">
                        <a href="{{ route('frontend.events.details', $recentEvent->id) }}">
                            <div class="recent-event-image">
                                <img src="{{ $recentEvent->banner_image ? asset('backend/uploads/organization_event/banner/' . $recentEvent->banner_image) : 'https://placehold.co/150x150/e76f51/ffffff?text=Event' }}" alt="{{ $recentEvent->event_name }}">
                            </div>
