...
<div class="sigma_subheader">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a class="btn-link" href="{{ route('frontend.organizations.details', $event->organization_id) }}">{{ $event->organization->name }}</a></li>
...
<div class="section">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                <!-- Organization Link -->
                <a href="{{ route('frontend.organizations.details', $event->organization_id) }}" class="organization-link">
                ...
                <div class="event-banner-wrapper">
                    <img src="{{ $event->banner_image ? asset('backend/uploads/organization_event/banner/' . $event->banner_image) : 'https://placehold.co/1200x600/e76f51/ffffff?text=Event+Banner' }}" alt="{{ $event->event_name }}">
                </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="related-events-section">
                    ...
                    <div class="related-event-card">
                        <a href="{{ route('frontend.events.details', $relatedEvent->id) }}">
                            <div class="related-event-image">
                                <img src="{{ $relatedEvent->banner_image ? asset('backend/uploads/organization_event/banner/' . $relatedEvent->banner_image) : 'https://placehold.co/400x200/e76f51/ffffff?text=Event' }}" alt="{{ $relatedEvent->event_name }}">
                            </div>
