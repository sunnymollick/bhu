                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('short_description') is-invalid @enderror"
                                  ...
                                  placeholder="Brief description for the about page">{{ old('short_description') }}</textarea>
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('who_we_are_title') is-invalid @enderror"
                               id="who_we_are_title" name="who_we_are_title" value="{{ old('who_we_are_title') }}"
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control summernote @error('who_we_are_content') is-invalid @enderror"
                                  ...
                                  placeholder="Describe who you are...">{{ old('who_we_are_content') }}</textarea>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control summernote @error('mission_content') is-invalid @enderror"
                                  ...
                                  placeholder="Describe your mission...">{{ old('mission_content') }}</textarea>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <p class="text-muted">Select multiple images (JPG, PNG, JPEG, GIF, max 2MB each).</p>
