...
<section class="content-header">
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
        <h1>Edit Organization Event</h1>
        </div>
        <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
            <li class="breadcrumb-item"><a href="{{ route('admin.organization_event.all') }}">All Events</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-warning">
                    ...
                    <form method="POST" action="{{ route('admin.organization_event.update', $event->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="organization_id" id="organization_id" class="form-control select2 @error('organization_id') is-invalid @enderror" required>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        @if($event->banner_image)
                                            <div class="mb-2">
                                                <img src="{{ asset('backend/uploads/organization_event/banner/' . $event->banner_image) }}" class="img-thumbnail" style="max-height: 150px;">
                                            </div>
                                        @endif
                                        ...
                                        <div class="row" id="existing-gallery">
                                            ...
                                            <div class="col-md-3 mb-2" id="gallery-{{ $gallery->id }}">
                                                <div class="position-relative">
                                                    <img src="{{ asset('backend/uploads/organization_event/gallery/' . $gallery->picture) }}" class="img-thumbnail" style="height: 150px; width: 100%; object-fit: cover;">
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ route('admin.organization_event.all') }}" class="btn btn-default">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    ...
    function deleteGalleryImage(galleryId) {
        if (confirm('Are you sure you want to delete this image?')) {
            $.ajax({
                url: '/admin/organization-event/gallery/' + galleryId,
                type: 'DELETE',
                data: {
                    _token: '{{ csrf_token() }}'
                },
