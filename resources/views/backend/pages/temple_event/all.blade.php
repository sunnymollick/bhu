        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('admin.temple_event.create') }}" class="btn btn-primary btn-sm float-right">
                        Add New Event
                    </a>
                </div>
                <div class="card-body">
                            ...
                            <tr>
                                <td>
                                    @if($event->banner_image)
                                        <img src="{{ asset('backend/uploads/temple_event/banner/' . $event->banner_image) }}" class="img-thumbnail" style="height: 50px; width: 80px; object-fit: cover;">
                                    @else
                                        <span class="badge badge-secondary">No Image</span>
                                    @endif
                                </td>
                                <td>{{ $event->event_name }}</td>
                                <td>{{ $event->temple->name ?? 'N/A' }}</td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="actionDropdown{{ $event->id }}">
                                            ...
                                            <a class="dropdown-item" href="{{ route('admin.temple_event.edit', $event->id) }}">
                                                <i class="fa fa-edit"></i> Edit
                                            </a>
                                            <a class="dropdown-item text-danger" href="javascript:void(0);" onclick="showDeleteModal({{ $event->id }}, 'Temple Event', '{{ route('admin.temple_event.destroy', $event->id) }}')">
