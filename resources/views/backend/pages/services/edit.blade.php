                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('title_bn') is-invalid @enderror"
                                       id="title_bn" name="title_bn" value="{{ old('title_bn', $service->title_bn) }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('description_bn') is-invalid @enderror"
                                          ...
                                          placeholder="Enter Bengali description">{{ old('description_bn', $service->description_bn) }}</textarea>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                @if($service->icon)
                                <div class="mt-2">
                                    <strong>Preview:</strong> <i class="fas {{ $service->icon }} fa-2x text-primary"></i>
                                </div>
                                @endif
                            </div>
                        </div>
